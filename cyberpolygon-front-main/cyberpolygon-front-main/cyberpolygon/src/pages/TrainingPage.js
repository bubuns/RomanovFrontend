    ...
    <div className="training-page">
      ...
      <header className="bg-primary text-white text-center py-5">
        <div className="container">
          <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=800&q=80" alt="Кибербезопасность обучение" className="page-header-image mb-4" style={{maxWidth: '350px', width: '100%', borderRadius: '12px'}} />
