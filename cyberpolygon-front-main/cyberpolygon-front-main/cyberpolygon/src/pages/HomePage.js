...
import CyberpoligonImage from '../assets/Cyberpoligon.jpg';
import AlexeyImage from '../assets/Alexey.jpg';
import MarinaImage from '../assets/Marina.jpg';
import DmitryImage from '../assets/Dmitry.jpg';
import MailImage from '../assets/Mail.png';
import PhoneImage from '../assets/Phone.png';
import PolygonImage from '../assets/polygon600.jpg';
      ...
      <div className="hero-section">
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-6">
              <img src={CyberpoligonImage} alt="Киберполигон" className="hero-image" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="row">
            <div className="col-md-4 mb-4">
              <div className="testimonial-card">
                ...
                <div className="testimonial-author">
                  <img src={AlexeyImage} alt="Пользователь" className="testimonial-avatar" />
                  <div>
                    <h5>Алексей П.</h5>
            ...
            <div className="col-md-4 mb-4">
              <div className="testimonial-card">
                ...
                <div className="testimonial-author">
                  <img src={MarinaImage} alt="Пользователь" className="testimonial-avatar" />
                  <div>
                    <h5>Марина С.</h5>
            ...
            <div className="col-md-4 mb-4">
              <div className="testimonial-card">
                ...
                <div className="testimonial-author">
                  <img src={DmitryImage} alt="Пользователь" className="testimonial-avatar" />
                  <div>
                    <h5>Дмитрий К.</h5>
                    <p>CIO компании</p>
                  </div>
